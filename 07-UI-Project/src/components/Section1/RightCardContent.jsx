...
const RightCardContent = (props) => {
  return (
    ...
    <div>
        <p className='text-shadow-2xs text-xl leading-relaxed text-white mb-14'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Atque asperiores culpa, saepe reprehenderit iure sit?</p>
